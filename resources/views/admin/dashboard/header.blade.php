      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="products/create"><i class="fa fa-circle-o"></i> Create product</a></li>
            <li><a href="products/edit/{$id}"><i class="fa fa-circle-o"></i> Edit product</a></li>
            <li><a href="products/list_product"><i class="fa fa-circle-o"></i> List product</a></li>
          </ul>
        </li>
        <li>
